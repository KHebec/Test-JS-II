...
function agregarAmigo(usuario, nuevoAmigo) {
  ...
  // // Tu código:
  // usuario = function(){usuario.push(nuevoAmigo)}
  // return usuario;
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
  let likes = []
  usuario[`posts`].forEach(post => likes.push(post["likes"]));
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  producto.precioConDescuento = function () {return producto.calcularPrecioDescuento()}
  return producto;
